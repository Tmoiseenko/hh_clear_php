...
<head>
    ...
    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="/public/front/css/honey.css" />
    ...
    <div class="container">
        <nav class="navbar">
            <a href="#" class="navbar-brand">
                <img src="/public/front/honeyimg/logo.png" alt="logo">
            </a>
        </nav>
        <div class="row">
            <div class="col-md-12 text-center">
                <img class="mail" src="/public/front/honeyimg/mail.png" alt="mail">
            </div>
            <div class="col-md-12">
                <form id="js_form" action="honeyhunters/create" method="post" class="form-row pb-5">
